...
- [ ] Replace static combat cutouts with animated player, enemy, and boss presentation. (All three playable characters now use authored four-pose combat sheets with cross-faded idle, left-bank, right-bank, and focused-attack states over a fixed hitbox. Procedural enemy/boss hover, banking, recoil, deformation, and damage states remain active; authored enemy and boss frame/skeletal animation remains.)
