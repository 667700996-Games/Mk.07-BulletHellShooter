...
The Combat Archive can replay the latest campaign run from its recorded input stream. Replays use versioned, checksummed data and deterministic encounter seeds, verify their result metrics at completion, and never modify campaign records.
